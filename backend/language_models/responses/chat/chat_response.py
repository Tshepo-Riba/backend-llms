...
class Choice(OpenAIBaseModel):
    index: Optional[int]
    message: Optional[ChatResponseMessage]
...
class ChatResponse(OpenAIBaseModel):
    ...
    Attributes:
        id (str): Identifier for the chat response.
    ...
    def __init__(
        ...
        object: Optional[Literal["chat.completion"]] = "chat.completion",
